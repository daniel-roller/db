            ...
            <div class="row">
               <div class="col-md-6">
                  ...
                  <div class="mail_sectin">
                     <input type="text" class="email-bt" placeholder="帳號" name="Name">
                     <input type="text" class="email-bt" placeholder="電子郵件" name="Name">
                     <input type="text" class="email-bt" placeholder="電話號碼" name="Name">
                     <div class="send_bt"><a href="login.php">確定</a></div>
                  </div>
               </div>
               <!-- <div class="col-md-6">
                  <div class="image_9"><img src=""></div> 
               </div> -->
            </div>
         </div>
      </div>
